Feature: Chart (of Accounts)
  Scenario: GET Chart
    ...
    And we should see Chart with edge "Inputs" -> Account "Raw Materials"
    And we should see Chart with edge "Inputs" -> Account "Parts"
    And we should see Chart with edge "Inputs" -> Account "Supplies"
    And we should see Chart with edge "Inventory" -> Account "Work in Progress"
    And we should see Chart with edge "Inventory" -> Account "Finished Goods"
